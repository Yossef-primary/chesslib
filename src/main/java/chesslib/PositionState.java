...
/**
 * Represents the state valueOf a chess position, including information about the current game state.
 */
public class PositionState {
    public int kingSquare;          // Square index valueOf the king
    public int numRepetition;       // Number valueOf times the position has been repeated
...
//
    ...
    public int ply;                 // Count valueOf half-moves from the initial position
    public int lastMove = 0;        // Encoded valueBy valueOf the last move made in the position
